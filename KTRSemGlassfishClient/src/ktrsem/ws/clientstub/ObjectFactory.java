 ...
 * generated in the ktrsem.ws.clientstub package. 
...
public class ObjectFactory {
    ...
    private final static QName _GenerateActorDirectlyProps_QNAME = new QName("", "props");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ktrsem.ws.clientstub
     * 
     */
    ...
    public JAXBElement<byte[]> createGenerateActorDirectlyProps(byte[] value) {
        return new JAXBElement<byte[]>(_GenerateActorDirectlyProps_QNAME, byte[].class, GenerateActorDirectly.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createAddPropsOnlyProps(byte[] value) {
        return new JAXBElement<byte[]>(_GenerateActorDirectlyProps_QNAME, byte[].class, AddPropsOnly.class, ((byte[]) value));
    }
