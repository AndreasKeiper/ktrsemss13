 ...
 * 
 */
@WebServiceClient(name = "WebServiceAccessService", targetNamespace = "http://webservice/", wsdlLocation = "file:/C:/Seminar/WebServiceAccessService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Seminar/WebServiceAccessService.wsdl");
